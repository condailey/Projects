...
class ListInterface {
    public:
        ...
        /** Removes the first occurrence of the given entry from this list.
         @pre  None.
         @post  If anEntry is in this list, the first occurrence of anEntry
                in the list is removed and the relative positions of the
                remaining entries are unchanged. The method returns true if
